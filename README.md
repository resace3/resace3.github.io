...
- Model Twin Randomization, a scroll-driven explainer of simulated n-of-1 trials
...
- `index.html`, `new-projects.html`, `activity-health-demo.html`: public site pages
- `motr/`: built bundle of the Model Twin Randomization explainer (source lives outside this repo)
- `style.css`, `script.js`: site styling and page transitions
...
- Playwright browser smoke tests for the home page, project pages, the MoTR explainer, and the proxied Causal DAG app
